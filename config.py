...
def build_config():
    ...
    config.add_argument('--tokenizer_name', type=str, default='fnlp/bart-base-chinese')
    ...
    config.add_argument('--pretrain_file_list', nargs='+', type=str, default=['./product_names.txt',])
    config.add_argument('--output_dir', type=str, default='./checkpoint')
    config.add_argument('--exp_name', type=str, default='bart-base-DAE')
    config.add_argument('--input_l', type=int, default=64)
    config.add_argument('--output_l', type=int, default=64)
